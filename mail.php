...
$mail->addAddress($uname, 'palash'); // to email and name
$mail->Subject = 'welcome';
$mail->msgHTML("welcome user 2"); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
